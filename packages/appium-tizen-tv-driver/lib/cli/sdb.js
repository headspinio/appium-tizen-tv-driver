...
async function debugApp ({appPackage, udid}) {
  ...
  try {
    ...
    throw new Error(`Unable to retrieve debugger port from debug start invocation. ` +
...
export { runSDBCmd, debugApp, listApps, forwardPort, removeForwardedPorts,
  connectDevice, disconnectDevice, removeForwardedPort };
