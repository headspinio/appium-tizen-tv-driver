...
| `appium:app`                    | A path to your `.wgt` app file if you want Appium to install the app. This can either be an absolute path or a https url to where the file is located on the internet.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
